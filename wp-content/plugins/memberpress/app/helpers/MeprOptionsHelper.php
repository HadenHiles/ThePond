  ...
  */
  public static function payment_methods_descriptions($payment_methods) {
    ...
    foreach($payment_methods as $payment_method) {
      ...
      ob_start();
      ?>
        <div id="<?php echo "{$field_name}-{$payment_method->id}"; ?>" class="mepr-payment-method">
          <div id="mp-pm-desc-<?php echo $payment_method->id; ?>" class="mepr-payment-method-desc-text spc <?php echo $desc_hidden; ?>">
