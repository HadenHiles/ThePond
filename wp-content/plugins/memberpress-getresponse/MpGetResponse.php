...
class MpGetResponse {
  ...
  public function ajax_mepr_gr_ping_apikey() {
    ...
    if( !isset($_POST['wpnonce']) or
      ...
      die( json_encode( array( 'error' => __('Hey yo, why you creepin\'?', 'memberpress-getresponse'),
                               'type' => 'memberpress' ) ) );
    // Validate inputs
    if( !isset( $_POST['apikey'] ) )
      die( json_encode( array( 'error' => __('No apikey code was sent', 'memberpress-getresponse'),
                               'type' => 'memberpress' ) ) );
