 ...
 * @package GetResponsePHP
 */
if(!class_exists('GetResponse')) { //Fixes issues with other plugins also using this class
  class GetResponse {
    /**
     * GetResponse API key
    ...
    private function execute($request)
    {
      ...
      curl_setopt($handle, CURLOPT_HEADER, 'Content-type: application/json'); //Pretty sure this is wrong - see below
