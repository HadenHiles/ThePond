...
<style>
	.mp-form-submit{width: 100%; margin-bottom: 35px;text-align: center;}
</style>
    ...
    <?php else: ?>
      ...
      <?php if(!$mepr_options->username_is_email): ?>
        <div class="mp-form-row mepr_username">
          ...
          <input type="text" name="user_login" id="user_login" class="mepr-form-input" placeholder="<?php _ex('Username*', 'ui', 'memberpress'); ?>" value="<?php echo (isset($user_login))?esc_attr(stripslashes($user_login)):''; ?>" required />
        </div>
      <?php endif; ?>
    ...
    <?php if($product->adjusted_price() > 0.00 || !empty($product->plan_code)): ?>
      <?php if($mepr_options->coupon_field_enabled): ?>
        <div class="mp-form-row mepr_coupon">
          ...
          <input type="text" id="mepr_coupon_code-<?php echo $product->ID; ?>" class="mepr-form-input mepr-coupon-code" name="mepr_coupon_code" placeholder="<?php _ex('Coupon Code:', 'ui', 'memberpress'); ?>" value="<?php echo (isset($mepr_coupon_code))?esc_attr(stripslashes($mepr_coupon_code)):''; ?>" data-prd-id="<?php echo $product->ID; ?>" />
        </div>
      <?php else: ?>
