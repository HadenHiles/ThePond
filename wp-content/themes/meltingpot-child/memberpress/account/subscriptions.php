...
if(!empty($subscriptions)) {
  ...
  echo '<div class="mepr-no-active-subscriptions">' . _x('You have no active subscriptions to display. ', 'ui', 'memberpress') . '<a href="/#choose-your-subscription">Pick your membership</a>.</div>';
}
