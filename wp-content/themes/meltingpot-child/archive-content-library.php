...
<section class="memberbenefits dashboardbenefits" style="min-height: 80vh;">
	<div class="challenges-wrapper">
		...
		<div class="bootstrap-styles challenges">
			...
			?>
				<a href="<?php if (get_field('available')) { ?><? the_permalink();
															} ?>" class="card shadow challenge filter <?php echo $class; ?>" data-category="<?= $termsString ?>" data-sort="value" data-search="<?php the_title(); ?>\n<?php echo get_field('description_short'); ?>">
