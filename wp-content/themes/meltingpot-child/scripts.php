...
wp_enqueue_script( 'datatables-fixedcolumns', get_template_directory_uri() . '/bootstrap-4.5.0/DataTables/FixedColumns-3.3.1/js/dataTables.fixedColumns.min.js', array(), null, true);
