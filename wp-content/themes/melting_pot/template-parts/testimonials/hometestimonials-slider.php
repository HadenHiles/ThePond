...
<div class="testimonials noslide  <?php  if ( get_field('number_of_testimonial_columns') == 1): ?>regular<?php endif; ?> <?php  if ( get_field('number_of_testimonial_columns') == 2): ?>twotest<?php endif; ?><?php  if ( get_field('number_of_testimonial_columns') == 3): ?>threetest<?php endif; ?>">
	<?php
	$args = array( 
		'posts_per_page' => '6',
		'orderby' => 'rand',
