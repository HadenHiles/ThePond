        ...
        <?php if (get_field('download_embed') == "embed") : ?>
            <?php if (get_field('audio_id')) : ?>
                <div class="sfwdaudio">
                    ...
                    <iframe style="border: none" src="//html5-player.libsyn.com/embed/episode/id/<?php echo get_field('audio_id'); ?>/height/90/theme/custom/thumbnail/no/direction/backward/render-playlist/no/<?php if (get_field('custom_libsyn_colour_code')) : ?>custom-color/<?php echo get_field('custom_libsyn_colour_code'); ?>/<?php endif; ?>" height="90" width="100%" scrolling="no" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
                </div>
            <?php endif; ?>
        <?php endif; ?>
