...
<section id="CourseHeader">
	<div class="row">

		<div class="medium-11 columns">
			<h1><?php if (get_field('custom_title')) : ?><?php echo get_field('custom_title'); ?><?php else : ?><?php the_title(); ?><?php endif; ?></h1>
			<?php if (get_field('lesson_sub')) : ?>
				<p><?php echo get_field('lesson_sub'); ?></p>
			<?php endif; ?>
