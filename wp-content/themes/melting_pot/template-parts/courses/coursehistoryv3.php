...
<?php if( trim($lesson_class_fav)  == 'post_tool_inactive' ) { ?>
 <li><a class="lesson_tool tool_fav<?php echo $lesson_class_fav; ?>" data-lesson-id="<?php echo get_the_id(); ?>" data-track-type="2"><i class="fa fa-heart"></i><span> </span></a></li>
 <?php }else{ ?>
  <li><a class="lesson_tool tool_fav<?php echo $lesson_class_fav; ?>" data-lesson-id="<?php echo get_the_id(); ?>" data-track-type="2"><i class="fa fa-heart"></i><span> </span></a></li>
<?php } ?> 

<?php if( trim($lesson_class_bookmark)  == 'post_tool_inactive' ) { ?>
<li><a class="lesson_tool tool_bookmark<?php echo $lesson_class_bookmark; ?>" data-lesson-id="<?php echo get_the_id(); ?>" data-track-type="1"><i class="fa fa-bookmark"></i> <span></span></a></li>
<?php }else{ ?>
	<li><a class="lesson_tool tool_bookmark<?php echo $lesson_class_bookmark; ?>" data-lesson-id="<?php echo get_the_id(); ?>" data-track-type="1"><i class="fa fa-bookmark"></i> <span> </span></a></li>
<?php } ?> 
</ul>
