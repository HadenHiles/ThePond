      ...
      <div class="FAQ_Wrap">
        <?php while (  have_posts() ) :  the_post(); ?>
		 <div id="faq_container"> 
			<div class="faq">
					<div class="faq_question"><span class="question"><strong>Topic: </strong> <?php the_field('topic'); ?></span></div>
					<div class="faq_answer_container">
						<div class="faq_answer">
                            <div class="topic"><p><strong>Question:</strong></p>  <div class="cliquestion"><p><?php the_title(); ?></p></div></div>
							<div class="answer"><p><strong>Answer: </strong></p> <div class="clianswer"><?php the_field('answer'); ?></div></div>
