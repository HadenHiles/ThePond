	...
	<div class="row">
		...
		<div class="large-4 medium-5 columns">
			...
			<?php if (get_field('welcome_bar_link_text')) : ?>
				<a href="<?php echo get_field('welcome_bar_link'); ?>" class="BTN dashBTN">
					<?php echo get_field('welcome_bar_link_text'); ?>
				<?php else : ?>
				<?php endif; ?>
					...
					<div class="large-8 columns">
						<div class="memberLatestContent">
							<?php if (get_field('content_before_title')) : ?>
								<h3><?php echo get_field('content_before_title'); ?></h3>
							<?php else : ?>
		...
		<div class="row">
			<div class="forumPosts">
				<?php if (get_field('community_header')) : ?>
					<h3><?php echo get_field('community_header'); ?></h3>
				<?php else : ?>
