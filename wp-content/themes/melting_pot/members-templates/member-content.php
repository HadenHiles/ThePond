...
<a class="BTN" href="<? echo the_sub_field('link_page')?>"><? echo the_sub_field('button_text')?></a> </div>
</li>
<? endwhile; ?>
</ul>
<? endif; ?>
...
<div class="<?php if($amountcol === '3'){echo "medium-4 small-6";}elseif($amountcol === '4'){echo "medium-3 small-6";} ?> columns end">
