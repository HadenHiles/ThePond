...
?>
<section class="Banner TestimonialHeader" style="background: url('<?php echo get_field('banner_image'); ?>')no-repeat;background-size:cover;background-position:center;">
	<div class="row">
...
<section class="MainContent testimonialpage">
	<div class="row">
		<div class="large-12 columns">
			...
			<main>
				<ul class="<?php echo get_field('test_columns'); ?>">
					<?php
