            ...
            <div class="memberBio">
                ...
                <div class="biotitleBox">
                    <?php if (get_field('business_logo')) : ?>
                        <img src="<?php echo get_field('business_logo'); ?>" alt="<?php the_title(); ?>" />
                    <?php endif; ?>
                    <h1 class="bioTitle"><strong><?php the_title(); ?></strong></h1>
                    <p><strong>Business:</strong> <?php echo get_field('business'); ?> <strong>Position:</strong> <?php echo get_field('position'); ?> </p>
                </div>
            ...
            <div class="ConnectWith">
                ...
                <ul>
                    <?php if (get_field('website_address')) : ?>
                        <li><a class="BTN bioWeb" target="_blank" href="<?php echo get_field('website_address'); ?>">View The Website</a></li>
                    <?php endif; ?>

                    <li><a class="BTN bioEmail" href="mailto:<?php echo get_field('email_address'); ?>">Email <?php the_title(); ?></a></li>

                    <?php if (get_field('phonenumber')) : ?>
                        <li><a class="BTN bioEmail" href="tel:<?php echo get_field('phonenumber'); ?>">Call <?php echo get_field('phonenumber'); ?></a></li>
                    <?php endif; ?>
                </ul>
                ...
                <div class="bioSocialLinks">
                    <ul>
                        <?php if (get_field('twitter_link')) : ?>
                            <li><a target="_blank" href="<?php echo get_field('twitter_link'); ?>"><i class="fa fa-twitter"></i></a></li>
                        <?php endif; ?>
                        <?php if (get_field('facebook_link')) : ?>
                            <li><a target="_blank" href="<?php echo get_field('facebook_link'); ?>"><i class="fa fa-facebook-f"></i></a></li>
                        <?php endif; ?>
                        <?php if (get_field('insta_link')) : ?>
                            <li><a target="_blank" href="<?php echo get_field('insta_link'); ?>"><i class="fa fa-instagram"></i></a></li>
                        <?php endif; ?>
                        <?php if (get_field('youtube_link')) : ?>
                            <li><a target="_blank" href="<?php echo get_field('youtube_link'); ?>"><i class="fa fa-youtube"></i></a></li>
                        <?php endif; ?>
                        <?php if (get_field('linkedin_link')) : ?>
                            <li><a target="_blank" href="<?php echo get_field('linkedin_link'); ?>"><i class="fa fa-linkedin-in"></i></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
