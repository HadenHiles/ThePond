...
?>
	...
	<section class="Banner BlogBanner">
		<div class="row">
							...
							<div class="blogpreview">
								...
								<div class="large-12 medium-12 columns nopad">
									<div class="blogprevtext">
										...
										<p class="timestamp"><?php if (get_field('author')) : ?><span><i class="fa fa-user"></i> <?php echo get_field('author'); ?></span><?php endif; ?> <span><i class="far fa-calendar-alt"></i> <?php echo get_the_date(); ?></span> <span><i class="far fa-folder"></i> <?php $cat = get_the_category();
																																																																												echo $cat[0]->name ?></span></p>
										<p class="excerpt"><?php $customexerpt = get_the_content();
															echo wp_trim_words($customexerpt, '14'); ?></p>
										<a href="<?php the_permalink(); ?>" alt="Article - <?php the_title(); ?>" class="BTN">Read More</a>test
									</div>
								</div>
							</div>
