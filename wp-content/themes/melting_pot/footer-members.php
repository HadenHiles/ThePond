	...
	<div class="row">
		<div class="large-2 columns">
			...
			<?php if ($smof_data['footer_logo']) { ?>
				<a href="/">
					<img src="https://cdn.thepond.howtohockey.com/2023/11/THEPOND_RGB_SNOWBANK.png" class="footerlogo" alt="<?php bloginfo('name'); ?> Logo" /></a>
				<!-- <img src="<?php echo $smof_data['footer_logo']; ?>" class="footerlogo" alt="<?php bloginfo('name'); ?> Logo" /> -->
				</a>
			<?php } ?>
		</div>
...
<?php if ($smof_data['extrafooterscripts']) {
	echo  $smof_data['extrafooterscripts'];
} ?>
