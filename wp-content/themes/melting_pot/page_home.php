...
?>
<section class="Banner" style="background-image: <?php if (get_field('banner_background')) : ?>url('<?php echo get_field('banner_background'); ?>');<?php else : ?><?php endif; ?>">
    <div class="row">
        <div class="<?php if (get_field('banner_media') == 'none') : ?>large-12<?php else : ?>large-6 <?php endif; ?>medium-12 columns">
            ...
            <h2><?php echo get_field('banner_sub_header'); ?></h2>
            <a href="<?php echo get_field('button_url'); ?>" class="BTN"><?php echo get_field('main_cta_button'); ?></a>
        ...
        <?php else : ?>
            <div class="large-6 medium-12 columns">
                <?php if (get_field('banner_media') == 'image') : ?>
                    <img src="<?php echo get_field('banner_image'); ?>" alt="Home Banner Image">
                <?php endif; ?>

                <?php if (get_field('banner_media') == 'video') : ?>
                    <div class="videoWrapper"><?php echo get_field('banner_video'); ?></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <section class="MainContent servicesection PainpointsSection">
        <div class="row">
            <div class="painpoints">
                <h3><?php echo get_field('pain_points_header'); ?></h3>
                <p><?php echo get_field('pain_points_header'); ?></p>
                <ul class="clearfix">
...
<section class="MainContent homeContent">
    <div class="row">
        ...
        <div class="<?php if (get_field('main_image')) : ?>large-6<?php else : ?>large-12<?php endif; ?> columns">
            <div class="homemain">
                <?php echo get_field('main_section_text'); ?>
            </div>
        </div>
    </div>
</section>
...
<section class="MainContent servicesection">
    <div class="row">
        ...
        <?php echo get_field('service_sub_heading'); ?>
        <ul class="services">
    ...
    <section class="blogfull hometest">
        <div class="row">
            <div class="large-12 columns">
                ...
                <div class="posttitle">
                    <h3><?php echo get_field('testimonials_heading'); ?></h3>
                    <p><?php echo get_field('testimonials_sub_heading'); ?></p>
                </div>
                <?php
